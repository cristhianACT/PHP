        ...
        <header>
            <div class="navbar container">
                ...
                <ul class="nav-links" id="nav-links">
                    ...
                    <li><a href="/ventas/nueva.php" class="nav-link <?= strpos($_SERVER['REQUEST_URI'], 'ventas/nueva') !== false ? 'active' : '' ?>"><i class="fa-solid fa-cash-register"></i> Ventas</a></li>
                    <li><a href="/ventas/historial.php" class="nav-link <?= strpos($_SERVER['REQUEST_URI'], 'ventas/historial') !== false ? 'active' : '' ?>"><i class="fa-solid fa-clock-rotate-left"></i> Historial</a></li>
                    ...
                    <li><a href="/categorias/listar.php" class="nav-link <?= strpos($_SERVER['REQUEST_URI'], 'categorias') !== false ? 'active' : '' ?>"><i class="fa-solid fa-tag"></i> Categorías</a></li>
                    <?php endif; ?>
                    <?php if(isset($_SESSION['usuario_rol']) && ($_SESSION['usuario_rol'] === 'admin' || $_SESSION['usuario_rol'] === 'cajero')): ?>
                    ...
                    <?php if(isset($_SESSION['usuario_rol']) && $_SESSION['usuario_rol'] === 'admin'): ?>
                    <li><a href="/usuarios/listar.php" class="nav-link <?= strpos($_SERVER['REQUEST_URI'], 'usuarios') !== false ? 'active' : '' ?>"><i class="fa-solid fa-users"></i> Usuarios</a></li>
                    <?php endif; ?>
